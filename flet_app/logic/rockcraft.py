...
class RockcraftGenerator:
    ...
    def _run_command(self, command, status_callback=None, timeout=3600):
        ...
        try:
            ...
            try:
                ...
                return_code = process.wait(timeout=10)  # Short timeout to wait for process to finish
    ...
    def init_rockcraft(self, status_callback=None) -> str:
        ...
        self._run_command(init_command, status_callback, timeout=300)
    ...
    def pack_rockcraft(self, status_callback=None) -> str:
        ...
        """
        if status_callback:
            status_callback("Packing Rock... This may take several minutes.")
        # Pack can take a long time for large projects, allow up to 1 hour
        self._run_command(["rockcraft", "pack"], status_callback, timeout=3600)
